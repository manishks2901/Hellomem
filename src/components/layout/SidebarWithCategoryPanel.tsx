    ...
    const fetchProducts = async () => {
      try {
        ...
        categories.forEach((cat) => {
          byCategory[cat.CategoryID] = allProducts
    ...
    <div className="flex h-screen bg-white">
      ...
      {selectedCategory ? (
        ...
        <div className="mt-6">
          ...
          {(categoryProducts[selectedCategory.CategoryID] || [])
        .slice(0, 4)
        .map((product) => (
        <div
        ...
        >
          ...
          src={
            ...
            product.ProductImagesJson[0]
            ? `${Config.ADMIN_BASE_URL}${product.ProductImagesJson[0].AttachmentURL}`
            : "/no-image.png"
          }
          alt={product.ProductName}
          className="w-20 h-20 object-cover rounded mb-2"
          />
          <div className="text-xs font-medium text-gray-800 text-center truncate w-full">
          {product.ProductName}
          </div>
